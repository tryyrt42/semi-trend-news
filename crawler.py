...
COMPANIES = [
    ...
    {"id": "실버칩스", "name": "실버칩스"},
    {"id": "코드세미콘", "name": "코드세미콘"},
    {"id": "에이엘피반도체", "name": "에이엘피반도체"},
    {"id": "알프스테크놀로지", "name": "알프스테크놀로지"},
    {"id": "워릭", "name": "워릭"},
    {"id": "에이치엔엘에스아이", "name": "에이치엔엘에스아이"},
    {"id": "인아웃로직", "name": "인아웃로직"},
    {"id": "아이티씨랩", "name": "아이티씨랩"},
    {"id": "스타칩스", "name": "스타칩스"},
    {"id": "파츠", "name": "파츠"},
    {"id": "싸이닉솔루션", "name": "싸이닉솔루션"},
    {"id": "피엘케이세미", "name": "피엘케이세미"},
    {"id": "아르떼테크놀러지", "name": "아르떼테크놀러지"},
    {"id": "노블테크", "name": "노블테크"},
    {"id": "에이투테크", "name": "에이투테크"},
    {"id": "서클", "name": "서클"},
    {"id": "액츠테크놀로지", "name": "액츠테크놀로지"},
    {"id": "에이에스디티", "name": "에이에스디티"},
    {"id": "웨이브글로벌", "name": "웨이브글로벌"},
    {"id": "세미콘트러스트", "name": "세미콘트러스트"},
    {"id": "세미캐드", "name": "세미캐드"},
    {"id": "온투로직", "name": "온투로직"},
    {"id": "에이치알솔루션", "name": "에이치알솔루션"},
    {"id": "세미솔루션", "name": "세미솔루션"},
    {"id": "엔칩", "name": "엔칩"},
    {"id": "믹스드세미콘", "name": "믹스드세미콘"},
    {"id": "나노디자인", "name": "나노디자인"},
    {"id": "케이엠시스", "name": "케이엠시스"},
    {"id": "디퓨전", "name": "디퓨전"},
    {"id": "타브실리콘", "name": "타브실리콘"},
    ...
    {"id": "알에프코어", "name": "알에프코어"},
    {"id": "fyd", "name": "FYD"},
    {"id": "코아시아넥셀", "name": "코아시아넥셀"},
    {"id": "에이디칩스", "name": "에이디칩스"},
    {"id": "이미지스", "name": "이미지스"},
    {"id": "아이케이세미콘", "name": "아이케이세미콘"},
    {"id": "메타씨앤아이", "name": "메타씨앤아이"},
    {"id": "티엘아이", "name": "티엘아이"},
    {"id": "위즈네트", "name": "위즈네트"},
    {"id": "쓰리에이로직스", "name": "쓰리에이로직스"},
    {"id": "글로벌테크놀러지", "name": "글로벌테크놀러지"},
    {"id": "스카이칩스", "name": "스카이칩스"},
    {"id": "라닉스", "name": "라닉스"},
    {"id": "해치텍", "name": "해치텍"},
    {"id": "퀄리타스반도체", "name": "퀄리타스반도체"},
    {"id": "하이딥", "name": "하이딥"},
    {"id": "수퍼게이트", "name": "수퍼게이트"},
    {"id": "피앤피네트워크", "name": "피앤피네트워크"},
    {"id": "넥스젠파워", "name": "넥스젠파워"},
    {"id": "포인투테크놀러지", "name": "포인투테크놀러지"},
    {"id": "베렉스", "name": "베렉스"},
    {"id": "테크위드유", "name": "테크위드유"},
    {"id": "아이닉스", "name": "아이닉스"},
    {"id": "아이씨티케이", "name": "아이씨티케이"},
    {"id": "아이언디바이스", "name": "아이언디바이스"},
    {"id": "비트리", "name": "비트리"},
    {"id": "옵토레인", "name": "옵토레인"},
    {"id": "파워큐브세미", "name": "파워큐브세미"},
    {"id": "매크로영상기술", "name": "매크로영상기술"},
    {"id": "클레버로직", "name": "클레버로직"},
    {"id": "엠텍비젼", "name": "엠텍비젼"},
    {"id": "실리콘핸즈", "name": "실리콘 핸즈"},
    {"id": "퓨리오사", "name": "퓨리오사"},
    {"id": "사피엔반도체", "name": "사피엔반도체"},
    {"id": "넷솔반도체", "name": "넷솔반도체"},
    {"id": "파이칩스", "name": "파이칩스"},
    {"id": "에이아이오", "name": "에이아이오"},
    {"id": "인프리즘", "name": "인프리즘"},
    {"id": "카멜테크놀러지", "name": "카멜 테크놀러지"},
    {"id": "아크칩스", "name": "아크칩스"},
    {"id": "4링크스", "name": "4링크스"},
    {"id": "랩쉽", "name": "랩쉽"},
    {"id": "유엑스팩토리", "name": "유엑스팩토리"},
    {"id": "디코드", "name": "디코드"},
    {"id": "네오와인", "name": "네오와인"},
    {"id": "넥스트랩", "name": "넥스트랩"},
    {"id": "블라썸테크놀러지", "name": "블라썸테크놀러지"},
    {"id": "인피니셜테크놀러지", "name": "인피니셜테크놀러지"},
    {"id": "헬스리안", "name": "헬스리안"},
    {"id": "원세미콘", "name": "원세미콘"},
    {"id": "그릿씨아이씨", "name": "그릿씨아이씨"},
    {"id": "디퍼아이", "name": "디퍼아이"},
    {"id": "솔리드뷰", "name": "솔리드뷰"},
    {"id": "다모아텍", "name": "다모아텍"},
    {"id": "스트라티오코리아", "name": "스트라티오 코리아"},
    {"id": "에티포스", "name": "에티포스"},
    {"id": "파이텍", "name": "파이텍"},
    {"id": "더웨이브톡", "name": "더웨이브톡"},
    {"id": "뉴라텍", "name": "뉴라텍"},
    ...
    {"id": "에스엔칩스", "name": "에스엔칩스"},
    {"id": "하이비", "name": "하이비"},
    {"id": "관악아날로그", "name": "관악아날로그"},
    {"id": "네메시스", "name": "네메시스"},
    {"id": "브이에스아이", "name": "브이에스아이"},
    {"id": "소테리아", "name": "소테리아"},
    {"id": "잇다반도체", "name": "잇다반도체"},
    {"id": "에임퓨처", "name": "에임퓨처"},
    {"id": "슈프리스", "name": "슈프리스"},
    {"id": "나노링크테크놀러지", "name": "나노링크테크놀러지"},
    {"id": "블루닷", "name": "블루닷"},
    {"id": "엑사리온", "name": "엑사리온"},
    {"id": "페블스퀘어", "name": "페블스퀘어"},
    {"id": "비욘드테크", "name": "비욘드테크"},
    {"id": "에이와이이노베이티브", "name": "에이와이이노베이티브"},
    {"id": "하이퍼엑셀", "name": "하이퍼엑셀"},
    {"id": "디노티시아", "name": "디노티시아"},
    {"id": "파네시아", "name": "파네시아"},
    {"id": "토닥", "name": "토닥"},
    {"id": "하이퍼비주얼에이아이", "name": "하이퍼비주얼에이아이"},
    {"id": "라텔세미컨덕터", "name": "라텔세미컨덕터"},
    {"id": "엑시나", "name": "엑시나"},
    {"id": "원익디투아이", "name": "원익디투아이"},
    {"id": "아나배틱세미", "name": "아나배틱세미"},
    {"id": "글로벌브릿지", "name": "글로벌브릿지"},
    {"id": "쿠오핀", "name": "쿠오핀"},
    {"id": "레오lsi", "name": "레오 LSI"},
    {"id": "루시드마이크로시스템즈", "name": "루시드마이크로시스템즈"},
    {"id": "하이퍼칩스", "name": "하이퍼칩스"},
    {"id": "아티크론", "name": "아티크론"},
    {"id": "포토링스", "name": "포토링스"},
    # ============ Foundry ============
    ...
    # 🇰🇷 대한민국
    {"id": "db하이텍", "name": "DB하이텍"},
    {"id": "keyfoundry", "name": "Key Foundry"},
    {"id": "skhynixsystemic", "name": "SK hynix system ic"},
    # 🇮🇱 이스라엘
    {"id": "towersemiconductor", "name": "Tower Semiconductor"},
    # 🇨🇳 중국
    {"id": "smic", "name": "SMIC"},
    {"id": "huahongsemiconductor", "name": "Hua Hong Semiconductor"},
    {"id": "nexchip", "name": "Nexchip"},
    # 🇹🇼 대만
    {"id": "powerchip", "name": "Powerchip"},
    {"id": "vis", "name": "VIS"},
    {"id": "winsemiconductors", "name": "WIN Semiconductors"},
    # 🇪🇺 유럽
    {"id": "x-fab", "name": "X-FAB"},
    # 🇲🇾 말레이시아
    {"id": "silterra", "name": "SilTerra"},
    # ============ EDA ============
    ...
    # ============ IDM ============
    # 🇰🇷 대한민국
    {"id": "samsungelectronics", "name": "Samsung Electronics"},
    {"id": "skhynix", "name": "SK Hynix"},
    # 🇺🇸 미국
    {"id": "microntechnology", "name": "Micron Technology"},
    {"id": "onsemi", "name": "onsemi"},
    {"id": "vishayintertechnology", "name": "Vishay Intertechnology"},
    # 🇪🇺 유럽
    {"id": "ams-osram", "name": "AMS-OSRAM"},
    # ============ OSAT ============
    # 🇰🇷 대한민국
    {"id": "amkorkorea", "name": "Amkor Korea"},
    {"id": "asekorea", "name": "ASE Korea"},
    {"id": "statschippackorea", "name": "STATS ChipPAC Korea"},
    {"id": "하나마이크론", "name": "하나마이크론"},
    {"id": "sfa반도체", "name": "SFA반도체"},
    {"id": "lb세미콘", "name": "LB세미콘"},
    {"id": "시그네틱스", "name": "시그네틱스"},
    {"id": "윈팩", "name": "윈팩"},
    {"id": "에이팩트", "name": "에이팩트"},
...
ALIASES = {
    ...
    "Cadence": ["케이던스"],
    "Siemens": ["지멘스 EDA"],
    # --- 2026-06 사이트(Semicon Radar) 반입 별칭 ---
    "워릭": ["Waric"],
    "아이티씨랩": ["ITC Lab"],
    "에이에스디티": ["ASDT"],
    "에이치알솔루션": ["HR Solution"],
    "DB하이텍": ["DB HiTek Co., Ltd."],
    "SMIC": ["Semiconductor Manufacturing International Corporation"],
    "Powerchip": ["PSMC", "Powerchip Semiconductor Manufacturing Corp."],
    "VIS": ["Vanguard", "Vanguard International Semiconductor"],
    "X-FAB": ["X-FAB Silicon Foundries SE"],
    "SilTerra": ["SilTerra Malaysia Sdn Bhd"],
    "Samsung Electronics": ["삼성전자"],
    "SK Hynix": ["SK하이닉스"],
    "Micron Technology": ["마이크론"],
    "onsemi": ["온세미"],
    "Vishay Intertechnology": ["비쉐이"],
    "AMS-OSRAM": ["AMS-오스람"],
    "Amkor Korea": ["앰코코리아"],
    "STATS ChipPAC Korea": ["스탯칩팩코리아 (JCET)"],
    "PTI": ["Powertech", "파워텍테크놀로지"],
}
